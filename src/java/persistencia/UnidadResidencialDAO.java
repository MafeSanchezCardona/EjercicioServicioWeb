...
public class UnidadResidencialDAO {
    ...
    public List<UnidadResidencial> listUnidadResidencial(Integer idUnidad) {
        List<UnidadResidencial> result = new ArrayList<>();
        String query = "select id, nombre, telefono, direccion, cantidad_aptos from unidad_residencial where id="+idUnidad;
        Connection con = new Conexion().getConexion();
